...
const OurTeam = () => {
  ...
  const founder = {
    ...
    edu: "BDS (Nair, Mumbai), MDS (Orthodontics, IDS)",
  ...
  const specialists = [
    ...
    },
    {
      ...
      edu: "BDS (GDC), MDS (Prosthodontics)",
      college: "PGIMER, Chandigarh",
            ...
            <div className="space-y-5 mb-8">
              <div className="flex gap-4">
                ...
                <div className="text-sm">
                  <p className="text-white font-bold">{founder.edu}</p>
